...
void interactive_day_1()
{
    ...
    while(dey != 4)
    {
        ...
        if(dey == 3)
        {
            ...
            print("Как оказалось 'монст' - это просто система выдачи зарплатыю\n", 60);
            print("Вам больше нечего делать возле SLOPE(так его назвал ИИ, кстати тоже произведен SLOPO.inc).\n", 60);
            wait(1000);
        }
        if(dey == 4)
        {
            print("Думая с меня хватит. Вы возращаетесь в центр комнаты, хотя ИИ видимо услышит вас из любой точки этой планеты.\n", 60);
            wait(1000);
            break;
        }
        clr;
