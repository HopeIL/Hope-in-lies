...
int32_t main()
{
    ...
    cout << endl;
    print("Вы просыпаетесь в небольшой комнате с железными стенами и тусклой грязной лампой на потолке.\n", 60);
    ...
    print("Вы не глядя сбрасываете одеяло с ног и медленно начинаете подниматься на ноги.\n", 60);
    ...
    print("В нижней части плаката видна надпись ' ИИ - ДРУГ ЧЕЛОВЕКА! '.\n", 70);
    ...
    wait(200);
    print(" пара букв явно западает.\nПравее от вашей клавиатуры лежит вытянутая компьютерная мышь,", 65);
    wait(70);
    ...
    wait(300);
    radio -> play();
    print("МЫ ЖИВЁМ В САМОЙ ПРЕКРАСНОЙ СТРАНЕ НА СВЕТЕ, А ВСЕ ОСТАЛЬНЫЕ СТРАНЫ НАМ ЗАВИДУЮТ!", 60);
    ...
    print(" Ваш компьютер издал несколько звуков похожих на треск или писк какого-то очень маленького прибора,", 70);ticket -> play();
    ...
    print("Снова проиграла запись смеха из того отвратительного шоу, от которого хотелось кинуть в телевизор даже вашей/*тут другое название книги, может 'похождениями'(ну того маркса карла), типа чтобы тот, кто не все осмотрел мог не понять о чем он*/\n", 60);
    ...
    if(tick == "1")
    {
        ...
        print("Не успели вы определиться, как 'монстр' в стене ожил и начал пыхтеть.\n", 60);
        print("Спустя пару мгновений он стал тужится, как женщина тужится при тяжелых родах.\n", 60);
        wait(1000);
///        pluh -> play();
        print("Из трубы показалась уродливая рожа какого-то инопланетного существа...s а... нет... это лишь ваше разыгравшееся воображение.\n", 60);
        print("Это была обычная пища, которой вас кормили, как казалось, с самого рождения.\n", 60);
        print("Её мерзкий вид ничуть не смущал вас, вы как и ваш любимый книжный герой ставили на первый план совсем другие ценности.\n", 60);
        wait(1000);
...
eat:
    ...
    if(sit == 1)
    {
        print("Хотя ваш перекус явно придал сил вашему и так изнывающему телу телу\n", 60);
    }

    print("L.A.I.: Думаю вам пора идти спать, можете занятся личными пока делами, у вас пару минут\n", 60);
    wait(1000);
    clr;
    print("Каким бы это странным не казалось, но обстановка в комнате заметно изменилась\n", 60);
    print("Какой бы грязной не была ваша комната, вы так и не смогли припомнить случая, чтобы она могла сравнится с этой\n", 60);
    print("Каким бы ужасным не было то шоу, тот улыбающийся ведущий никогда не выглядел так жутко\n", 60);
    print("Даже взяв в руки вашу любимую книгу, вы не ощутили той привычной теплоты, вы ощутили лишь холод обложки\n", 60);
    print("Вы решили разузнать: что же не так?\n", 60);
    print("Для начала вы решили осмотреть самые обыденные для вас вещи:\n", 60);
    interactive_day_1_2()
        update_save();
}
