...
//    clr;
//    tasks();
//    print("Вы работали весь день в поте лица, впрочем, почему нет\n", 60);
//    print("Сегодня вы справились на удивление быстро\n", 60);
//    print("А это значит...\n", 60);
//    wait(1000);
//    print("Значит, что вы получите премию\n", 60);
//    print("Ваши радостные мысли прервал короткий звон", 60);
//    print("А потом из компьютера моментально вылетел голубовато-белый билетик с большими буквами: /*вот тут название его места работы*/ \n", 30);
