...
int32_t main()
{
    ...
    if(tick == "1")
    {
        ...
        wait(1000);
///        pluh -> play();
        print(" Как вам показалось, местами машина даже чем-то походила на пищеварительную систему, только из кучи проводов, болтов, металлических держателей, двигающихся туда и обратно металлических цилиндров и целый горы разнообразных лампочек, вентелей и вещей, что вам явно не нужно трогать. Что-то, предположительно являвшееся вашей едой, медленно протискивалась по связке труб, идущих прямо из стены, по пути несколько раз застревая. Они издавали неприятный скрежет и немного покачивались.", 70);
        print(" По трубам ваша еда попала в пожелтевший, пропитанный чем-то жирным или скользким мешок, напоминающий больной чем-то желудок. От него несло несло целой горой различных разъедающих глаза запахов, от какой-то сырости грязи, до давно сгнившей воды. 'Желудок' немного поддерживал свою форму, при помощи тонких железных ободков и держателей, но помогали они плохо. Стало сразу понятно когда еда попала в этот растянутый мешок, он заметно просел от веса, и из-за материала из которого он был сделан.", 70);
        print(" Когда вся еда дошла до мокрого мешка, что-то щёлкнуло, а металлические ободки и держатели начали сжиматься и разжиматься в разной последовательности, медленно проталкивая еду дальше по трубам.", 70);
        print(" Дальше ваше лакомство попало в большую, похожую на кишечник трубу и еда снова продолжила свой долгий путь до вашей тарелки. Лампочки внизу механизма начали моргать разными цветами, а внутри машины было слышно звонкое пиканье и звуки похожие на работу тяжёлого железного пресса. Труба начала немного сгибаться и даже извиваться, толкая вашу пищу дальше. Наконец, большая согнутая труба, похожая на краник затряслась, зашаталась и из отверстия показался край бесформенной болотно-бурой массы.", 70);
        print(" Где-то через минуту, на середине работы, краник перестал так сильно трястись и процесс встал. Вы недолго думая размахнулись и удали по металлическому кранику кулаком, было немного больно, но еда не только пошла дальше, но и сама работа заметно ускорилась.", 70);
        print(" До чего же странные эти машины.\n", 70);
